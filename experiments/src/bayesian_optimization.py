...
def gen_sample_from_qei_mcmc(cpp_gp_mcmc, cpp_search_domain, sgd_params, start_points, num_to_sample, num_mc=1e4, lhc_itr=2e4):
    """
    ...
    points_to_sample_list.append(multistart_expected_improvement_mcmc_optimization(ei_optimizer=optimizer,
                                                                                   num_multistarts=start_points.shape[0],
                                                                                   start_point_set=start_points,
                                                                                   num_to_sample=1, max_num_threads=1))
    cpp_ei_evaluator.set_current_point(points_to_sample_list[0])
